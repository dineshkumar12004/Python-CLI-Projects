...
def kbc():
    ...
    while ( i <15 ):
        ...
        #if user says quit anywhere in between
        if ans.lower()=='quit':
            if(i-1)<0:
                print("The total reward won is Rs.0")
            else:
        ...
        elif lifeline_valid==False and i!=14 and ans.lower == 'lifeline':
            print('You have already used your lifeline.')


        print(f'Total lifelines left: {lifeLine(i)}')
        
        if isAnswerCorrect(i, int(ans) ):
            # print the total money won.
            print(f'Total price won: {QUESTIONS[i]["money"]}')
            ...
            if i<6:
                print('The total reward you won is Rs. 0.')
            elif i<10:
                print('The total reward you won is Rs. 10,000.')
            else:
                print('The total reward you won is Rs. 3,20,000.')
            game_play=False
            break

        # print the total money won in the end.2
